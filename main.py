...
class Ui(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.dialog = secondPage() #İkinci sayfamızın sınıfı, bunu çağırabilmek için kullanacağız.
        self.changeLabelButton.clicked.connect(self.openSecondPage) #Tıklayınca ikinci sayfa yönlendirecek.
    ...
    def changeData(self, data): #Veri değiştiğinde label adlı yazı bölgemize değerimizi atıyoruz.
...
class secondPage(QtWidgets.QMainWindow): #ikinci sayfanin sinifi burada bulunmaktadir.
    ...
    def __init__(self):
        ...
        self.okButton.clicked.connect(self.changeName) #Butona tıkladığımızda fonksiyon çalışıyor.
